...
class User extends Component {  
    ...
    componentDidMount(){
        ...
        const urls = [
            ...
            'http://localhost:3000/users/projects/'+this.state.user_id,
            'http://localhost:3000/areas/logged/'+this.state.user_id,
                            ...
                            <Card >
                                {
                                    this.state.user.map(user =>
                                        <Card.Img variant="top" src={require(`./../images/user/${user.first_name.toLowerCase()}.jpg`)} />
                                    )
                                }
